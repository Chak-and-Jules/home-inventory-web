...
import { Package, Box, LogOut, LayoutDashboard, UserCircle, BarChart3, ShoppingCart, Wrench, Utensils } from 'lucide-react'
...
export function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  const navigation = React.useMemo(() => [
    ...
    { name: t('layout.recipes'), href: '/recipes', icon: Utensils },
